...
const contactInfo = [
  {
    icon: <Email />,
    title: 'Email Us',
    primary: 'hello@brasetech.com',
    secondary: 'support@brasetech.com',
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        <Box textAlign="center" sx={{ mb: 8 }}>
          ...
          <Typography variant="body1" sx={{ maxWidth: 600, mx: 'auto' }}>
            ...
            expert team to discuss your requirements and receive a personalized solution.
          </Typography>
        </Box>
      </Container>
            ...
            <Box sx={{ position: 'sticky', top: 100 }}>
              ...
              <Paper elevation={2} sx={{ p: 3 }}>
                ...
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                  <Chip label="24h Response" color="primary" size="small" />
                  <Chip label="Free Consultation" color="secondary" size="small" />
                  <Chip label="No Obligation" variant="outlined" size="small" />
                </Box>
              </Paper>
            </Box>
          </Grid>
        ...
        >
          <Box textAlign="center">
            ...
            <Typography variant="body2" color="text.secondary">
              In the meantime, you can find us at our San Francisco headquarters
            </Typography>
          </Box>
        </Paper>
      </Container>
