...
export const ContactPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            emailjs.init("rYyK0wpQOGcQzEihG"); // Replace with your EmailJS public key
            ...
            await emailjs.send(
                "service_1jmxx0k", // Replace with your EmailJS service ID
                "template_tn0afsb", // Replace with your EmailJS template ID
                templateParams,
            );
