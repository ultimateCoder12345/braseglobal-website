      ...
      <Box sx={{ pt: 10, position: 'relative', zIndex: 1 }}>
        ...
        <Container maxWidth="lg" sx={{ py: 8 }}>
          <Box textAlign="center" sx={{ mb: 8 }}>
            ...
            <Box sx={{ height: 4, background: 'linear-gradient(90deg, #1976d2, #42a5f5)', borderRadius: 2, width: 100, mx: 'auto', mb: 4 }} />
        ...
        {/* Join Our Team CTA */}
        <Box sx={{ bgcolor: 'rgba(25, 118, 210, 0.95)', color: 'white', py: 8, backdropFilter: 'blur(10px)' }}>
          <Container maxWidth="lg">
